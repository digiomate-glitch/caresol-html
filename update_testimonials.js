...
testimonials.forEach((t, index) => {
    ...
    const starsHtml = `<div class="quote-stars" style="color: #FBBF24; display: flex; gap: 4px; margin-bottom: 12px;">
              ${Array(5).fill('<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 17.27L18.18 21L16.54 13.97L22 9.24L14.81 8.63L12 2L9.19 8.63L2 9.24L7.46 13.97L5.82 21L12 17.27Z"/></svg>').join('\\n              ')}
            </div>`;
...
const pattern = /(<!-- Review 1 -->\s*<div class="quote-card".*?)(?=\s*<\/div>\s*<\/div>\s*<!-- Controls -->)/s;
